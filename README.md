...
| workflow\_trigger | Trigger for the Workflow . Cloud Scheduler OR Event Arc | <pre>object({<br>    cloud_scheduler = optional(object({<br>      name                  = string<br>      cron                  = string<br>      time_zone             = string<br>      deadline              = string<br>      argument              = optional(map(any))<br>      service_account_email = string<br>    }))<br>    event_arc = optional(object({<br>      name                  = string<br>      service_account_email = string<br>      matching_criteria = set(object({<br>        attribute = string<br>        operator  = optional(string)<br>        value     = string<br>      }))<br>      pubsub_topic_id = optional(string)<br>    }))<br>  })</pre> | n/a | yes |
